...
\usepackage{xurl}
\usepackage{booktabs}  % Tạo đường kẻ ngang đẹp (toprule, midrule, bottomrule)
\usepackage{tabularx}  % Tự động căn chỉnh độ rộng bảng cho vừa trang giấy
\usepackage{makecell}  % Giúp xuống dòng trong một ô (dùng cho tiêu đề cột)
\usepackage{array}     % Hỗ trợ định dạng cột
\usepackage{tikz}
\usetikzlibrary{shapes, arrows, positioning, calc, positioning, arrows.meta, shapes, fit, backgrounds, shadows}
